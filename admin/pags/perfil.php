<?php
	$idUser = isset($_SESSION['usuarioID']);
...
<?php
	if(isset($_POST['alt']) && isset($_POST['alt']) == "cad"){
		if($_POST['nome'] && $_POST['usuario'] && $_POST['senha']){
			...
			// >=1 : ATUALIZOU 
			// 0 : NÃO ATUALIZOU nada
			// -1 : ERRP AP ATUALIZAR/ ERRO NA QUERY
		}else{
